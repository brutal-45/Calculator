...
const variantClass: Record<Variant, string> = {
  default:
    'bg-zinc-800/70 hover:bg-zinc-700/80 active:bg-zinc-600 text-white border border-white/[0.06] shadow-sm shadow-black/10',
  operator:
  ...
  wide: 'bg-zinc-800/70 hover:bg-zinc-700/80 active:bg-zinc-600 text-white border border-white/[0.06] shadow-sm shadow-black/10',
